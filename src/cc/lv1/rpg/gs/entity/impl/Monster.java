...
public class Monster extends NPC
{
	...
	public void copyTo(GameObject dest)
	{
		...
		monster.clearPhySmite = clearPhySmite;
		monster.clearPhySmiteParm = clearPhySmiteParm;
		monster.clearSptSmite = clearSptSmite;
		monster.clearSptSmiteParm = clearSptSmiteParm;
		monster.clearNoDefHurt = clearNoDefHurt;
	...
	public boolean setVariable(String key, String value)
	{
		...
		{
			experience = Long.parseLong(value);
			return true;
		}
		else
		{
	...
	public void writeTo(ByteBuffer buffer)
	{
		...
		buffer.writeInt((int) experience);
	...
	public void writeBattleTo(ByteBuffer buffer)
	{
		...
		buffer.writeByte(0);
		buffer.writeByte(0);
		buffer.writeBoolean(false);//没有守护
	}
